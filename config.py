...
YT_API_KEY = getenv("YT_API_KEY" , None ) ## Your API key like: xbit_SfF71Mml-aCkkdWSq2uCClHumsUNU02A Get from  https://t.me/tgmusic_apibot
...
UPSTREAM_REPO = getenv(
    "UPSTREAM_REPO",
    "https://github.com/ixbittu/Venab",
)
